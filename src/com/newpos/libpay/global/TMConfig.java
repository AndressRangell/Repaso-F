...
public class TMConfig implements Serializable {
    ...
    private TMConfig() {
        try {
            ...
            Logger.exception( "TMConfig.java", pse);
            Logger.error("TMConfig->" , pse.toString());
        }
    }
    ...
    public static TMConfig getInstance() {
        ...
        if (mInstance == null) {
            try {
                ...
                Logger.exception( "TMConfig.java", e);
    ...
    private void loadFile(Context context, String path) {
        Logger.info("loadFile->path:" + path);
        String T = "1";
        ...
        if (properties != null) {
            ...
            while (enumeration.hasMoreElements()) {
                ...
                Logger.info("loadFile->name:" + name);
                if (!PAYUtils.isNullWithTrim(name)) {
                    ...
                    try {
                        switch (index - 1) {
                            ...
                            case 19:
                                ...
                                if (isInit){
                                    ...
                                    if(tablaDevice.selectTConfig(context)) {
                        ...
                        Logger.exception( "TMConfig.java", e);
                        Logger.error("loadFile->" , e.toString());
                    }
                }
            }
        }
